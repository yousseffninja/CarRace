...
public class MultiM3MediumCarListener extends AnimListener {
    ...
    String textureNames[] = {"maincar_1.png","line.png","car_left_22.png", "anmy_1.png", "bg3-m.png"};
...
//
        //left r
        DrawLine(gl, x2+70, y1, 1, 0.3f);
        DrawLine(gl, x2+70 , y3, 1, 0.3f);
        DrawLine(gl, x2+70 , y4, 1, 0.3f);

        //right
        DrawLine(gl, x1-170 , y1, 1, 0.3f);
