...
//        }
        ...
        if (menu.onePlayer.isSelected()  == true && maps.mapThree.isSelected()  == true && levels.easy.isSelected()  == true) {
            setVisible(false);
            new SEM3();
        }

        if (menu.twoPlayers.isSelected()  == true && maps.mapOne.isSelected()  == true && levels.easy.isSelected()  == true) {
            setVisible(false);
            new MEM1();
        }

        if (menu.twoPlayers.isEnabled()  && maps.mapTwo.isEnabled() && levels.easy.isEnabled()) {
            setVisible(false);
            new MEM2();
        }

        if (menu.twoPlayers.isEnabled() && maps.mapThree.isEnabled() && levels.easy.isEnabled()) {
            setVisible(false);
            new MEM3();
        }
    }
