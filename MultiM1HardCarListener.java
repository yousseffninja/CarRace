...
public class MultiM1HardCarListener extends AnimListener {
    ...
    private int Xgenerate1 = -1000;
    private int Xgenerate2 = -1000;
    private int Xgenerate3 = -1000;
    private int Xgenerate4 = -1000;
    ...
    String textureNames[] = {"maincar_1.png","line.png","car_left_22.png", "anmy_1.png","bg1-m.jpeg"};
...
//        if((x == Xgenerate1 && y == yEnemy1) || (x == Xgenerate2 && y == yEnemy2) || (x == Xgenerate3 && y == yEnemy3) || (x == Xgenerate4 && y == yEnemy4)){
    ...
    public int generateXLeft(int x){
        x = 60 + (int)(Math.random() * 260);
        return x;
    }

    public int generateXRight(int x){
        x = 500 + (int)(Math.random() * 250);
        return x;
    }
